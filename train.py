...
class Train:
    def __init__(self,root):
        ...
        img_top = Image.open("E:/CHINTAN/SEM 4/python/project/img/ex1.jpg")
        ...
        b5_1.place(x=0, y=355, width=1366, height=85)

        img_bottom = Image.open("E:/CHINTAN/SEM 4/python/project/img/ex2.jpg")
        img_bottom = img_bottom.resize((1366,300), Image.ANTIALIAS)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=0, y=440, width=1366, height=300)
