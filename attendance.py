...
#=================variables==========================
        ...
        img = img.resize((683, 180), Image.ANTIALIAS)
        self.photoimg = ImageTk.PhotoImage(img)

        f_lbl = Label(self.root, image=self.photoimg)
        f_lbl.place(x=0, y=0, width=683, height=180)


#second image ................
        img1 = Image.open("img/7.jpg")
        img1 = img1.resize((683, 180), Image.ANTIALIAS)
        self.photoimg1 = ImageTk.PhotoImage(img1)

        f_lbl = Label(self.root, image=self.photoimg)
        f_lbl.place(x=683, y=0, width=683, height=180)
...
#bg image ................
        ...
        bg_img.place(x=0, y=180, width=1366, height=586)
...
# title.................................
 ...
 #left lable frame................
        ...
        img_left = Image.open("E:/CHINTAN/SEM 4/python/project/img/pre.jpg")
        img_left = img_left.resize((560, 170), Image.ANTIALIAS)
