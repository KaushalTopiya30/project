...
#1st image...............................................
        img_top = Image.open("E:/CHINTAN/SEM 4/python/project/img/recognize.jpg")
        img_top = img_top.resize((600,660), Image.ANTIALIAS)
        self.photoimg_top = ImageTk.PhotoImage(img_top)

        f_lbl = Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0, y=55, width=600, height=660)


#2nd image...............................................

        img_bottom = Image.open("E:/CHINTAN/SEM 4/python/project/img/r1.jpg")
        img_bottom = img_bottom.resize((766,660), Image.ANTIALIAS)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=600, y=55, width=766, height=660)
        ...
        b5_1.place(x=235, y=600, width=300, height=40)
#===========================attendance===================================
